 ...
 */
class Version20180227151141 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE symfony_demo_role (id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, role VARCHAR(20) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_554AC88257698A6A ON symfony_demo_role (role)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE symfony_demo_role');
